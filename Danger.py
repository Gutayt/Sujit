...
TOKEN = 7604226240:AAGsc-IivAVRKAsjIfSB1sip5cRpmMDERuk
MONGO_URI = 'mongodb+srv://Dangerboyop:FJgjOtOZ2z8kUptY@dangerboyop.nyzgq.mongodb.net/'
FORWARD_CHANNEL_ID = -1002365457520
CHANNEL_ID = -1002365457520
error_channel_id = -1002365457520
...
def create_inline_keyboard():
    ...
    button3 = types.InlineKeyboardButton(
        text="❤‍🩹 𝗝𝗼𝗶𝗻 𝗢𝘂𝗿 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 ❤‍🩹", url="https://t.me/TOXIC_STOCK")
    button1 = types.InlineKeyboardButton(text="👤 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗢𝘄𝗻𝗲𝗿 👤",
        url="https://t.me/TOXIC_STOCK")
    markup.add(button3)
    markup.add(button1)
    return markup
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"
                                       ...
                                       "*Please contact the owner for assistance: @TOXIC_BST.*", 
                                       reply_markup=create_inline_keyboard(), parse_mode='Markdown')
            return

        # Parse the command arguments: /attack <ip> <port> <duration>
        args = message.text.split()[1:]  # Ignore the command itself and get arguments
        if len(args) != 3:
        ...
        bot.send_message(chat_id, f"*🚀 Attack Initiated! 🚀*\n\n"
    ...
    try:
        ...
        if not user_data:
            ...
            button2 = types.InlineKeyboardButton(
                text="💸 𝗣𝗿𝗶𝗰𝗲 𝗟𝗶𝘀𝘁 💸", url="https://t.me/TOXIC_STOCK/8436")
            markup.add(button1)
            markup.add(button2)
        else:
